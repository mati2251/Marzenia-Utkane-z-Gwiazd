...
const Footer = () => {
    ...
    sponsors.forEach((item, index) => {
        if (index < howManyPerColumn) {
            firstColumn.push(<a href={item.link} className={styles.footer__mainElementDark} key={item.id}>
                <h3>{item.nazwa}</h3></a>)
        } else {
          ...
          <section className={styles.footer__main}>
              ...
              <div className={styles.footer__mainColumn}>
                  ...
                  <div className={styles.footer__mainColumnContact}>
                      <div>
                          <h3
                            className={`${styles.footer__mainElementDark} ${styles.footer__mainContactElement}`}>Mail:</h3>
                          <h3 className={`${styles.footer__mainElementDark} ${styles.footer__mainContactElement}`}>Numer
                              Telefonu:</h3>
                      </div>
                      <div>
                          <h3 className={styles.footer__mainElementDark}>mail@example.com</h3>
                          <h3 className={styles.footer__mainElementDark}>+48 666 666 666</h3>
                      </div>
                  </div>
              </div>
              <div className={styles.footer__mainColumn}>
                  ...
                  <a href="https://www.facebook.com/marzeniautkanezgwiazd/" target="_blank" rel="noopener noreferrer"
                     className={styles.footer__mainElementDark}>
                      <FaFacebook className={styles.footer__mainSocialIcon}/> <h3> Facebook </h3></a>
                  <a href="https://www.instagram.com/marzeniautkanezgwiazd/" target="_blank" rel="noopener noreferrer"
                     className={styles.footer__mainElementDark}>
                      <FaInstagram className={styles.footer__mainSocialIcon}/> <h3> Instagram </h3></a>
                  <a href="https://www.youtube.com/channel/UC4GqrrJdK-Dfg15coY3RslA" target="_blank"
                     rel="noopener noreferrer" className={styles.footer__mainElementDark}>
                      <FaYoutube className={styles.footer__mainSocialIcon}/> <h3> YouTube </h3></a>
              </div>
          </section>
